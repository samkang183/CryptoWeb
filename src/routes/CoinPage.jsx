    ...
    <div className='grid md:grid-cols-2 gap-8'>
      ...
      <div className='flex justify-between py-4'>
        <div>
          ...
          {coin.market_data?.market_cap ? (<p>${coin.market_data.high_24h.usd.toLocaleString()}</p>) : null}
        </div>
        <div>
          <p className='text-gray-500 text-sm'>24h Low</p>
          {coin.market_data?.market_cap ? (<p>${coin.market_data.low_24h.usd.toLocaleString()}</p>) : null}
        </div>
      </div>
    </div>
